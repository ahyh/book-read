...
import com.yh.tomcat.read.chapter3.processor.ServletProcessor;
import com.yh.tomcat.read.chapter3.processor.StaticResourceProcessor;
...
//    protected StringManager sm = StringManager.getManager(Constants.Package);
    ...
    public void process(Socket socket) {
        ...
        try {
            ...
            response.setHeader("Server", "YH Servlet Container");
